...
public class BaseProductController {
    ...
    /**
     * method that creates a new base product and inserts it into the list
     * of all products in the file ser.txt
     */
    @FXML
    ...
    /**
     * method that will check if all the fields are of the needed type
     *
     * @return true/false
     */
