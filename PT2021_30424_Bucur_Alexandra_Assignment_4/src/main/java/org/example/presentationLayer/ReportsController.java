...
public class ReportsController {
    ...
    /**
     * methid that sets all the textFields with the right string
     */
    ...
    /**
     * method that will show to the user some controls needed for the report generation
     */
    @FXML
    ...
    /**
     * method that will generate the reports and show in a field all the needed information
     */
    @FXML
        ...
        if (minHText.isVisible() && maxHText.isVisible() && Integer.parseInt(minHText.getText()) < Integer.parseInt(maxHText.getText())) {
            if (checkInput(minHText) && checkInput(maxHText)) {
                ...
                infoArea.setText(deliveryService.generateReportsTimeInterval(Integer.parseInt(minHText.getText()),
                        Integer.parseInt(maxHText.getText())));
                minHText.setVisible(false);
                maxHText.setVisible(false);
            }
        } else {
    ...
    /**
     * method that will check if the input from the text field is an int
     *
     * @param textField textField to be cheked
