...
public class ControllerAdmin {
    ...
    public void initialize() {
        col1.setCellValueFactory(new PropertyValueFactory<org.example.businessLayer.MenuItem, String>("Title"));
    ...
    /**
     * Method that will open another page with all the reports that will be generated by the administrator
     */
    @FXML
    ...
    /**
     * method that will open new oages based on the button that was clicked
