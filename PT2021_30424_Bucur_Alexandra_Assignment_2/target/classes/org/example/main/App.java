...
public class App extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        try {
            FXMLLoader loader = new FXMLLoader(new File("C:\\Users\\Alexandra\\Desktop\\PT2021_30424_Bucur_Alexandra_Assignment_2\\src\\main\\java\\org\\example\\view\\screen.fxml").toURI().toURL());
